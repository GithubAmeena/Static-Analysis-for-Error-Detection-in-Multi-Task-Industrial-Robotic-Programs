    ...
    private static boolean c3() throws IOException {
        ...
        for (int m = 0; m < parsedTasks.size() - 1; m++) {
            ...
            for (int n = m + 1; n < parsedTasks.size(); n++) {
               ...
               // System.out.println("Wait instruction name in task1 :" + p1.WaitInstruction.instructionName);
                ...
                if (p1.waitInstructionsList.size() != p2.waitInstructionsList.size()) {
                    System.out.println("Unequal WaitUntil_TestAndSet instructions in the 2 tasks and the tasks are potentially data racy");
                    return false;
                }
                ...
                for (i = 0; i < p1.waitInstructionsList.size(); i++) {
                ...
                while ((lbl = br1.readLine()) != null)  {
                    ...
                    if(lbl.startsWith("PROC MAIN()") && taskCount==1)
                    {
                        ...
                        while((lbl2 = br1.readLine()) != null){
                            ...
                            String temp = "WaitUntil_TestAndSet("+boolVariable+");";
